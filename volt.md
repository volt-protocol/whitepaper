...
## Liquid Governance
The goal of the VCON governance system is to let tokenholders directly allocate protocol assets and make governance decisions while individually having skin in the game. That means that they benefit or suffer most from their individual governance decisions, not the result of majority consensus. We accomplish this with a special lending pool for VCON holders, based on the Tribe Turbo system.
...
* borrowers can only deposit assets into governance-approved yield venues like Turbo, not just walk away with them
* borrowing will be incentivized in this pool so active VCON holders dilute passive holders
